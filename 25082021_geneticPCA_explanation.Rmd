...
klippy::klippy(tooltip_message = 'Click to copy code', tooltip_success = 'Done', color = "red")
```
...
```{r prepare_data, eval=FALSE,echo=TRUE, class.source='klippy'}
library(data.table)
library(devtools)
library(GenomicSEM)
library(knitr)
...
#melt to plot
row.names(lower_triangle)<-c("Speeding","Drinking","Smoking","Sexual partners")
colnames(lower_triangle)<-c("Speeding","Drinking","Smoking","Sexual partners")
library(reshape2)
...
heatmap <- heatmap+
  ...
  ggtitle("Genetic correlations (LDSC)")
...
#C:/Users/k1894405/OneDrive - King's College London/Documents/GitHub/genomicPCA/data
setwd(paste0(substring(getwd(), first = 1, last = 18),"Documents/GitHub/genomicPCA/data"))
...
intercept <- heatmap+
  geom_text(aes(Var1,Var2,label=corrected),color="black",size=4)+
  ggtitle("Intercepts (LDSC)")
...
#png("C:/Users/k1894405/OneDrive - King's College London/PhD/Thesis/Chapter1 Genomic PCA/images/Fig1.png", width = 11, height = 7, units = 'in', res=1000)
#plot_grid(plot[[1]], plot[[2]], scale = 0.95, labels = c("A", "B"))
#dev.off()
```
...
row.names(lower_triangle)<-c("Speeding","Drinking","Smoking","Sexual partners","Phenotypically\nextracted PC1","Genetically\nextracted PC1")
colnames(lower_triangle)<-c("Speeding","Drinking","Smoking","Sexual partners","Phenotypically\nextracted PC1","Genetically\nextracted PC1")
...
png("C:/Users/k1894405/OneDrive - King's College London/PhD/Thesis/Chapter1 Genomic PCA/images/Eval.png", width = 11, height = 7, units = 'in', res=1000)
plot_grid(plot[[1]], plot[[2]], scale = 0.95, labels = c("A", "B"))
dev.off()
```
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/pheno_vs_genoPC.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/speeding_vs_genoPC.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/drinking_vs_genoPC.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/smoking_vs_genoPC.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/sexual_vs_genoPC.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/pheno_vs_genoPC_unstand.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/speeding_vs_genoPC_unstand.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/drinking_vs_genoPC_unstand.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/smoking_vs_genoPC_unstand.jpg)
...
![](C:/Users/k1894405/Documents/GitHub/genomicPCA/plots/sexual_vs_genoPC_unstand.jpg)
